...
SOURCE_PATTERNS = [
    ...
    r"/watcher/codes/[^/]+-[^/]+-[^/]+/hw(?:[0-9]|10)/[^/]+\.(c|h|py|cpp|hpp)$",                     # 0depth
    r"/watcher/codes/[^/]+-[^/]+-[^/]+/hw(?:[0-9]|10)/[^/]+/[^/]+\.(c|h|py|cpp|hpp)$",              # 1depth
    r"/watcher/codes/[^/]+-[^/]+-[^/]+/hw(?:[0-9]|10)/[^/]+/[^/]+/[^/]+\.(c|h|py|cpp|hpp)$",        # 2depth
]
...
LOG_BACKUP_COUNT = int(os.getenv('LOG_BACKUP_COUNT', '0'))  # 10개 백업 파일
